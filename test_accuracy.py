...
if __name__ == '__main__':
    ...
    df_user=pd.read_csv('user_1_processed.csv')
    ...
    # 3. 输出生成报告所需文件
    Report_data.to_csv('output_data/report_data/'+ 'report_data_' + 'tester1_no_imputation' + '.csv',index=False)